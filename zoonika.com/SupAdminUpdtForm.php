...
if(isset($_GET['id']) && ($_GET['id']!== '')){
	...
	$sql="SELECT * from user where user_id = '$product_id'";
	$db->query($sql);
	$item = $db->single();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    user_password = '$password', department_id = '$department'
   ...
   <form  method="post">
		<div id="container" style='margin-bottom:6em;text-align:center;'>
			<h1> Update Form For an Employee</h1>
                ...
                <?php $department = $item->department_id;?>
				<label for="department_id"><br>Department</br></label>
				<select name="department" required>

                    <option value= "" <?php if($department == "") echo "SELECTED";?> >N/A</option>
				    <option value= 1 <?php if($department == 1) echo "SELECTED";?>>Animal's department</option>
                    <option value= 2 <?php if($department == 2) echo "SELECTED";?>>Membership's department</option>
                    <option value= 3 <?php if($department == 3) echo "SELECTED";?>>Ride's department</option>
                    <option value= 5 <?php if($department == 5) echo "SELECTED";?>>Sale's department</option>
                    <option value= 6 <?php if($department == 6) echo "SELECTED";?>>Product's department</option>
