...
Class AddAnimalClass
{
	...
	public function profileFill(){
		...
		$sql = "INSERT INTO  animal (animal_name, department_id, animal_DOB, animal_gender, animal_breed, animal_display) VALUES ('$this->animal_name', '$this->department_id', '$this->animal_DOB', '$this->animal_gender', '$this->animal_breed', '$this->animal_display')";
		try{
		$this->db->query($sql);
